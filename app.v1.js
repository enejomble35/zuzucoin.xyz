(function(){
  ...
  var CONFIG = {
    ...
    // Türkiye saatiyle 5 Kasım 2025 13:00
  ...
  window.CONFIG = CONFIG; // solana.v1.js kullanıyor
  ...
  var LAUNCH_AT=(function(){
    var t=Date.parse(CONFIG.launchAtISO); // ES5 uyumlu
    if(!isNaN(t)) return t;
    return Date.now()+50*DAY;
  })();
  function tick(){
    try{
