/* ===========================================
   ...
   • Auto-retry: görünür olunca 10 sn boyunca dene
   • UI: logolar png/svg fallback
=========================================== */
(function () {
  ...
  async function trySolflare(trusted=true){
    try{
      ...
      await s.connect();  // Solflare onlyIfTrusted paramını dikkate almıyor
  ...
  window.addEventListener("load", async ()=>{
    // cüzdan webview’inde açıldıysa otomatik bağlanmayı dene
  ...
  function openWalletModal(){
    ...
    el.innerHTML = `
      ...
      <div class="wallet-box">
        ...
        <p class="note">On mobile, the site will open inside the wallet. Approve <b>zuzucoin.xyz</b> and you'll be connected.</p>
