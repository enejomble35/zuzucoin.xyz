...
const I = {
  en:{nav_presale:"Pre-Sale",nav_stake:"Stake",nav_nft:"NFT Rewards",nav_roadmap:"Roadmap",nav_token:"Tokenomics",connect:"Connect Wallet",
      ...
      amount:"Amount (ZUZU)",cost:"Cost:",buy:"Buy",
      stake_title:"Stake Pro — Lock, Earn, Get NFT ✨",
      stake_lead:"Lock your ZUZU, earn <b>APY + NFT BOOST</b>.",
  ...
  tr:{nav_presale:"Ön Satış",nav_stake:"Stake",nav_nft:"NFT Ödülleri",nav_roadmap:"Yol Haritası",nav_token:"Tokonomi",connect:"Cüzdan Bağla",
      ...
      amount:"Miktar (ZUZU)",cost:"Maliyet:",buy:"Satın Al",
      stake_title:"Stake Pro — Kilitle, Kazan, NFT Kap ✨",
      stake_lead:"ZUZU’larını kilitle, <b>APY + NFT BOOST</b> ile kazan.",
...
(function initLang(){
  ...
  langBtn && langBtn.addEventListener("click",(e)=>{e.stopPropagation();langMenu?.classList.toggle("show");});
